...
- **Hallazgo:** la SSOT declara que no existe "system boundary" como entidad visual (V-71). Herramientas y notación OPM de terceros (OPCloud, SysEngine) sí dibujan cajas envolventes. La implementación de `opmodel` necesita aclarar que cualquier grupo visual en UI es decoración, no entidad, y que la frontera del sistema se lee por contorno de cada thing.
